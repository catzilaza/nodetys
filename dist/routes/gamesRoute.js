...
// GET
exports.gamesRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const games = (yield databaseService_1.collections.games.find({}).toArray());
...
exports.gamesRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const game = (yield databaseService_1.collections.games.findOne(query));
        if (game) {
...
exports.gamesRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield databaseService_1.collections.games.insertOne(newGame);
        result
            ? res
                .status(201)
...
exports.gamesRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield databaseService_1.collections.games.updateOne(query, {
            $set: updatedGame,
        });
        result
...
exports.gamesRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield databaseService_1.collections.games.deleteOne(query);
